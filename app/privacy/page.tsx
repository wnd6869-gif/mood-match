      ...
      <article className="mt-7 space-y-4">
              ...
              <tbody className="[&_td]:border-b [&_td]:border-neutral-100 [&_td]:px-2 [&_td]:py-2.5 [&_td]:align-top">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    분위기 키워드, 페르소나 설명·제목, AI 기본 ID 후보와
                    최종 기본 ID,
                    시각적 특성값, 모델·토큰 사용량
                  </td>
                ...
                <tr>
                  <td>대화</td>
                  <td>
                    대화 요청, 채팅방·참여자 정보, 채팅 메시지,
                    상호 사진 공개 동의·철회 상태와 시각, 읽음·숨김·퇴장 시각
                  </td>
        ...
        <LegalSection title="8. 이용자 권리와 행사 방법">
          <p>
            ...
            상호 사진 공개 동의는 각 1:1 채팅에서 언제든 철회할 수
            있습니다. 선택 마케팅 동의 철회와 그 밖의 권리 행사는 아래 문의처로
